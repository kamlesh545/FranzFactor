 ...
 * {@link myfranchise.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link myfranchise#newInstance} factory method to
 * create an instance of this fragment.
 */
public class myfranchise extends Fragment {
    ...
    private Adaptermyfranchise mAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
   public List<Datafranchise> data = new ArrayList<>();
    ...
    public void setemaill(String string) {
        email = string;
    }
     ...
     * @return A new instance of fragment myfranchise.
     */
    // TODO: Rename and change types and number of parameters
    public static myfranchise newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myInflatedView = inflater.inflate(R.layout.fragment_myfranchise, container, false);
        mRVfranchiselist = (RecyclerView) myInflatedView.findViewById(R.id.recycler_view);
         empty = (TextView) myInflatedView.findViewById(R.id.empty_vieww);
        getData();
    ...
    private void getData() {
        ...
        String url = Config.myFranchise_URL + email;
    ...
    private void showJSON(String result) {
        ...
        try {
            ...
            for (int i = 0; i < jArray.length(); i++) {
                ...
                franchisedata.status = json_data.getString(Config.KEY_STATUS);
                data.add(franchisedata);

            }
            mAdapter = new Adaptermyfranchise(getActivity(), data);
